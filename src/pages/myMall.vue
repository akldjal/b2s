              ...
              <el-table :data="datas">
                ...
                <el-table-column prop="id" label="操作">
                  <template slot-scope="scope">
                    <el-button @click="buy(scope.row)" type="text">购买</el-button>
                    <el-button @click="add(scope.row)" type="text"><i class="el-icon-plus"></i></el-button>
                  </template>
                </el-table-column>
              </el-table>
            </el-main>
